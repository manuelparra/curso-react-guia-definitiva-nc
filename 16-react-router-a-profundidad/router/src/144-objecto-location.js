import { Outlet, Routes, Route, NavLink, useParams, Navigate, useNavigate, useLocation } from 'react-router-dom'
...
const App = () => {
  ...
  const chanchito = query.get('chanchito')
  const nombre = query.get('nombre')
  console.log({ chanchito, nombre })
